{% snapshot snapshot_inventory_item_level_alice_ames %}
...
from {{ source('shopify_alice_ames', 'inventory_item') }} as i
left join {{ source('shopify_alice_ames', 'inventory_level') }} as l 
