...
{{ config(alias="dash_marketing_by_reporting_period") }}
...
with orders_l30d_ty as (
    ...
    from {{ ref('base_rpt_paid_media_metrics_by_day_ad') }} as m
...
, l30d as (
    select 
        ...
        {{ insert_marketing_kpi_comparison_metrics() }}
...
, orders_ytd_monthly_ty as (
    select
        ...
        , date_trunc('month',m.reporting_date) as reporting_date
