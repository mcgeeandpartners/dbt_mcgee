...
with final as (
    ...
    from {{ ref('stg_order_line_item_tenkara_usa') }} as oli 
    --for null variant ids
    left join {{ ref('base_int_null_product_variant_backfill_tenkara_usa') }} as pvb 
    ...
    left join  {{ ref('base_int_null_product_variant_backfill_tenkara_usa') }} as pvb2 
