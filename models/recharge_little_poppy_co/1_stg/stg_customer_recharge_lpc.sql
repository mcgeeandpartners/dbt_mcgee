...
final as (
    ...
    select
        ...
        cast(created_at as {{ dbt.type_timestamp() }}) as customer_created_at_utc,
        cast(updated_at as {{ dbt.type_timestamp() }}) as customer_updated_at_utc,
        cast(first_charge_processed_at as {{ dbt.type_timestamp() }}) as first_charge_processed_at_utc,
        ...
        billing_country,
        billing_phone,
        has_valid_payment_method::boolean as has_valid_payment_method,
        reason_payment_method_not_valid,
        has_card_error_in_dunning::boolean as has_card_error_in_dunning, 
        ...
        has_payment_method_in_dunning::boolean as has_payment_method_in_dunning,
